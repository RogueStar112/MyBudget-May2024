...
@endphp
            ...
            <style type="text/css">
                ...
                <h1>PERCENTAGE HISTORY TABLE</h1>
                <p>How much your budget is taken up represented as a percentage</p>
                ...
                <div class="color-legend d-flex">
                  <ul class="d-flex" style="margin: 10px; width: 100%; justify-content: space-around; font-size: 25px;">
                    ...
                    <li style="background-color: hsl(150, 100%, 50%);"><£25%<br>WELL WITHIN BUDGET</li>
                    <li style="background-color: hsl(80, 100%, 50%);">>25% - 75%<br>WITHIN BUDGET</li>
                    <li style="background-color: hsl(45, 100%, 50%);">>75% - 100%<br>SUITABLE BUDGET</li>
                    <li style="background-color: hsl(25, 100%, 50%);">>100% - 200%<br>OVERSPENT</br></li>
                    <li style="background-color: hsl(0, 100%, 30%); color: white; font-weight: 800;">>200%<br>GROSSLY OVERSPENT</li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @php
                          ...
                          $DATERANGE_SUM = $DATERANGE_SUM + $DATERANGE_SUM_SUBTRANSACTIONS;
                          ...
                          if ($DATERANGE_SUM_BUDGET != 0) {
                              $TOTAL_SUM = ($DATERANGE_SUM / $DATERANGE_SUM_BUDGET) * 100;
                          } else {
                              $TOTAL_SUM = 0;
                          }
                        ...
                        @endphp
                              ...
                              @if($TOTAL_SUM != 0)
                                ...
                                @if($TOTAL_SUM > 75 and $TOTAL_SUM <= 100)

...
<style type="text/css">
  ...
  <p>The money you've spent by far</p>
  ...
  <div class="color-legend d-flex">
    <ul class="d-flex" style="margin: 10px; width: 100%; justify-content: space-around; font-size: 25px;">
      ...
      <li style="background-color: hsl(150, 100%, 50%);"><£25<br>Miniscule Spending</li>
      <li style="background-color: hsl(80, 100%, 50%);">>£25 - £75<br>Minor Spending</li>
      <li style="background-color: hsl(45, 100%, 50%);">>£75 - £199<br>Major Spending</li>
      <li style="background-color: hsl(25, 100%, 50%);">>£200 - £499<br>Large Spending</li>
      <li style="background-color: hsl(0, 100%, 30%); color: white; font-weight: 800;">>£500<br>Huge Spending</li>

    ...
    <div id="app">
        ...
        <div class="container">
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="4">Date Ranges</th>
                    </tr>

                    <tr class="month-scale">
                        <th colspan="2">May</th>
                    ...
                    <tr>
                        <th class="icon-combo">test2</th>
                        <th class="icon-combo">test3</th>
                        <th class="icon-combo">test4</th>
                        <th class="icon-combo">test5</th>
                    </tr>
                </thead>

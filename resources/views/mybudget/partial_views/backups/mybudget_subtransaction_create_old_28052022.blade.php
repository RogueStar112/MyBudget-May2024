...
<body>
    ...
    <div class="container subtransaction-container mt-3" >
        ...
        <tr class="upper-line-cutoff" id="subtransactions">
            ...
            <td><input class="subtransaction-1 form-input" type="text" name="subtransaction-1-category" value="" required/></td>

            <td><input class="subtransaction-1 form-input" type="text" name="subtransaction-1-subcategory" value="" required/></td>
...
<script>
    ...
    function createNewSubtransaction() {
        ...
        category_cell.innerHTML = `<input class="subtransaction-${subtransaction_count} form-input" type="text" name="subtransaction-${subtransaction_count}-category" required>`

        var subcategory_cell = row.insertCell(4);

        subcategory_cell.innerHTML = `<input class="subtransaction-${subtransaction_count} form-input" type="text" name="subtransaction-${subtransaction_count}-subcategory" required>`

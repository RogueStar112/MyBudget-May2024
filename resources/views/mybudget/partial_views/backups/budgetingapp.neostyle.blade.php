...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body>
      ...
      <div class="container">
        ...
        -->
        <div class="row">
            <div class="col-sm" style="background-color: #198754; color: white;">
            ...
            <div class="col-sm" style="background-color: #FF6A00; color: white;">
        ...
        <div class="row">
            <div class="col-sm" style="background-color: #0026FF; color: white;">
            ...
            <div class="col-sm" style="background-color: green; color: white;">
            ...
            <div class="col-sm" style="background-color: red; color: white;">
        ...
        <div class="row">
            ...
            <div class="col-sm" style="background-color: #808080; color: white;">

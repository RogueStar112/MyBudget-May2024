                        ...
                        @endphp
                              ...
                              @if($DATERANGE_SUM != 0 xor $DATERANGE_SUM_SUBTRANSACTIONS != 0)
                                ...
                                <td style="background-color: hsl(150, 100%, 50%);" class="custom-tooltip">
                                  <a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}">{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a>
                                </td>
                                ...
                                <td style="background-color: hsl(80, 100%, 50%);" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a></td>
                                
                                @endif

                                @if($TOTAL_SUM > 75 and $TOTAL_SUM <= 199)
                                <td style="background-color: hsl(45, 100%, 50%);" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a></td>
                                @endif

                                @if($TOTAL_SUM > 199 and $TOTAL_SUM <= 500)
                                <td style="background-color: hsl(25, 100%, 50%); font-weight: 600;" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a></td>
                                @endif

                                @if($TOTAL_SUM > 500)
                                <td style="background-color: hsl(0, 100%, 30%); color: white; font-weight: 800;" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a></td>
                                @endif
                              @endif
                              ...
                              @if($DATERANGE_SUM_SUBTRANSACTIONS != 0 and $DATERANGE_SUM != 0)
                                ...
                                <td style="background-color: hsl(150, 100%, 50%);" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}<br>Money spent: </span></a></td>
                                ...
                                @if($TOTAL_SUM > 500)
                                <td style="background-color: hsl(0, 100%, 30%); color: white; font-weight: 800;" class="custom-tooltip"><a href="{{ config('app.url')}}/budgeting-app/app/transactions/show/{{$section_id}}/{{$months_Carbon}}/{{$months_Carbon_addweek}}">£{{number_format($TOTAL_SUM, 2)}} <span class="custom-tooltip-span" id="custom-tooltip-span-{{$section_id}}-{{$months_Carbon_idformat}}"><div class="color-strip" style="background-color: {{$category_selected['color-bg']}};"></div>{{$section_name}}<br>{{date('M j Y', strtotime($months_Carbon))}} - {{date('M j Y', strtotime($months_Carbon_addweek))}}</span></a></td>
                                @endif

        ...
        <form method="POST" action="{{ config('app.url')}}/budgeting-app/app/" class="form-transaction mt-3" id="THE-FORM">
            ...
            <div class="add_transaction_form d-none">
                ...
                <div class="row" id="input-field-1">
                    <div class="col m-3 transaction-1"><label for="transaction-name-1">Name</label><input class="form-control" id="transaction-name-1" name="transaction-name-1" placeholder="Frozen Peas" ></input></div>
                    <div class="col m-3 transaction-1"><label for="transaction-price-1">Price (£)</label><input class="form-control" id="transaction-price-1" name="transaction-price-1" placeholder="0.79" ></input></div>
                </div>
                <div class="row" id="input-field-2">

                    <div class="col m-3 transaction-1"><label for="transaction-category-1">Category</label>
                    <select class="form-select" id="transaction-category-1" name="transaction-category-1"  placeholder="Groceries">
                    ...
                    <div class="col m-3 transaction-1"><label for="transaction-subcategory-1">Subcategory</label><input class="form-control" id="transaction-subcategory-1" name="transaction-subcategory-1" placeholder="Frozen Food" ></input></div>
                </div>

                    ...
                    @foreach($GET_SECTIONS as $SECTION)
                        ...
                        @if($loop->iteration % 2 == 1)
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @php
                                    if ($section_sum != NULL) {
                                        if (($section_sum / $budget_of_section) > 1) {
                        ...
                        @else
                            <tr class="text-center" style="background-color: {{$category_selected['color-bg']}}; color: {{$category_selected['color-text']}};  ">
                                ...
                                <td>
                                    @php
                                    if ($section_sum != NULL and $SECTION_BUDGET->budget != NULL ) {
                                        if (($section_sum / $SECTION_BUDGET->budget) > 1) {
                                            
                                            $perc = number_format(((float)$section_sum / $SECTION_BUDGET->budget) * 100, 2);

            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @foreach($GET_SECTIONS as $SECTION)
                        ...
                        <td class="col-md-4 text-center">{{$SECTION->name}}</td>
                        <td class="d-flex justify-content-around">
                            ...
                            @php
                                ...
                                $section_selected = $SECTION_BUDGET->section_id ?? 'N/A';

                                
                            @endphp

                            <input class="form-control" placeholder="Budget" value="{{(float)number_format($SECTION_BUDGET->budget, 2)}}" unique_category="{{$category_selected['id']}}" unique_identifier="{{$SECTION->id}}" 
                            id="input-budget-{{$SECTION->id}}" name="input-budget-{{$SECTION->id}}" /> 
                        ...
                        <td>
                            ...
                            if($SECTION->id == $section_selected) {
                                $budget_of_section = $SECTION_BUDGET->budget ?? 'N/A';
                            } else {
                                $budget_of_section = 'N/A';
                            }
                            ...
                            if ($section_sum != NULL and $budget_of_section != 'N/A' ) {
                                ...
                                // If Sum Divided by Budget is greater than 100%;

                ...
                @isset($category_selected)
                    @if ($id == 'ALL')
                        ...
                        */
                        ...
                        @endphp
                        <div class="sample-category-container mt-3" id="sample-category-container" style="margin: 0 auto; color: {{$category_selected->color_text}}; position: relative; background: linear-gradient(90deg, #FFFFFF, {{$category_selected->color_bg}});">

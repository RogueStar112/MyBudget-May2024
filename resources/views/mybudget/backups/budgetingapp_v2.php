...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <link href="{{ asset('css/mybudget_viewhistory_tooltips_for_menu.css') }}" rel="stylesheet" type="text/css">
   </head>
   <body>
      <div id="app">
      ...
      <div class="container">
        <div class="row mt-3" id="mybudget-menu-text">
            <h1>MyBudget Menu</h1>
        </div>
        <div class="row">
            <div class="budgetingapp-container budgeting-app-menu-categories col-sm m-3" style="";>

                <div class="budgeting-app-menu-title">Categorization</div>
                
                <div class="budgeting-app-menu-subtitle"></div>

                <div class="budgeting-app-menu-icon"><i class="fas fa-book"></i></div>

                <div class="budgeting-app-link-container">

                    <a href="{{ config('app.url')}}/budgeting-app/app/categories/create">
                    <div class="budgeting-app-link">Categories

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-shopping-cart"></i></div>
                        </div>
                    </div>
                    </a>
            ...
            <div class="budgetingapp-container budgeting-app-menu-transactions col-sm m-3" style=" ">
                
                
                <div class="budgeting-app-menu-title">Transactions</div>
                
                <div class="budgeting-app-menu-subtitle"></div>

                <div class="budgeting-app-menu-icon"><i class="fas fa-shopping-cart"></i></div>

                <div class="budgeting-app-link-container">

                    <a href="{{ config('app.url')}}/budgeting-app/app/create">
                    <div class="budgeting-app-link">TRANSACTIONS

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-shopping-cart"></i>
                    ...
                    <div class="budgeting-app-link">Sources
                    ...
                    <div class="budgeting-app-link">Sections

                        
                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-question"></i></div>
                        </div>

                    </div>
                    </a>

                    <div class="budgeting-app-link">Subtransactions
            ...
            <div class="budgetingapp-container budgeting-app-menu-budget col-sm m-3">

                
                <div class="budgeting-app-menu-title">Budget</div>
                
                <div class="budgeting-app-menu-subtitle"></div>

                <div class="budgeting-app-menu-icon"><i class="fas fa-money-bill-alt"></i></i></div>

                <div class="budgeting-app-link-container">
                    

                    <a href="{{ config('app.url')}}/budgeting-app/app/budget">
                    <div class="budgeting-app-link">SET BUDGET

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-wallet"></i></div>
                        </div>
                    </div>
                    </a>
                    ...
                    <div class="budgeting-app-link">HISTORY

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-history"></i></div>
                        </div>
                    </div>
                    </a>

                    <a href="{{ config('app.url')}}/budgeting-app/app/items/history">
                    <div class="budgeting-app-link">ITEMS

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-pizza-slice"></i></div>
                        </div>
                    </div>
                    </a>
            ...
            <div class="budgetingapp-container budgeting-app-menu-statistics col-sm m-3">


                
                <div class="budgeting-app-menu-title">Statistics</div>
                
                <div class="budgeting-app-menu-subtitle"></div>

                <div class="budgeting-app-menu-icon"><i class="fas fa-chart-line"></i></div>

                <div class="budgeting-app-link-container">

                    <a href="{{ config('app.url')}}/budgeting-app/app/statistics">
                    <div class="budgeting-app-link">Overview

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-chart-line"></i></div>
                        </div>
                    </div>
                    </a>

                    <a href="{{ config('app.url')}}/budgeting-app/app/reports">
                    <div class="budgeting-app-link">Reports

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-scroll"></i></div>
                        </div>
                    </div>
                    </a>

                    <a href="{{ config('app.url')}}/budgeting-app/app/compare">
                    <div class="budgeting-app-link">Comparisons

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-balance-scale"></i></div>
                        </div>
                    </div>
                    </a>
            ...
            <div class="budgetingapp-container budgeting-app-menu-settings col-sm m-3">

                
                <div class="budgeting-app-menu-title">Misc</div>
                
                <div class="budgeting-app-menu-subtitle"></div>

                <div class="budgeting-app-menu-icon"><i class="fas fa-cog"></i></div>

                <div class="budgeting-app-link-container">

                    <div class="budgeting-app-link">Help
                    ...
                    <div class="budgeting-app-link">Settings

                        <div class="budgeting-app-link-icon-container">
                            <div class="budgeting-app-link-icon"><i class="fas fa-cog"></i></div>
                        </div>
                    </div>
   ...
   <script>
      $(document).ready(function() {
        ...
        $(`.budgeting-app-link-icon`).on('mousemove', function(e){
        
        $('span', this).css({left: (e.clientX - (e.clientX * 0.95)), top: (e.clientY - (e.clientY * 0.95))});

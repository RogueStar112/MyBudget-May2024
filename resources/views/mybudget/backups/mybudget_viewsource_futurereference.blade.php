                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                $GET_UNIQUE_SECTIONS_FROM_SOURCE = DB::table('mybudget_item')
                                ...
                                ->join('mybudget_source', 'mybudget_item.source_id', '=', 'mybudget_source.id')
                                ->select('mybudget_item.*', 'mybudget_section.name as section_name', 'mybudget_category.name as category_name')
                                ->where('mybudget_item.source_id', '=', $SOURCE->id)
                                ->where('mybudget_item.category_id', '=', $category_selected->id)
                                ...
                                @foreach($GET_UNIQUE_SECTIONS_FROM_SOURCE as $UNIQUE_SECTION)
                                    @if($loop->last)
                                    <p style="font-size: 8px; margin-bottom: 0;">{{$SOURCE->id}} {{$category_selected->id}} {{$UNIQUE_SECTION->section_name}}</p>
                                    @else
                                    <p style="font-size: 8px; margin-bottom: 0;">{{$SOURCE->id}} {{$category_selected->id}} {{$UNIQUE_SECTION->section_name}}, </p>
                                    @endif
                                @endforeach

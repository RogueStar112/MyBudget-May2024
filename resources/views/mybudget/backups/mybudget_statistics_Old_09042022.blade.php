...
<body>
    <div id="app">
        ...
        <div class="container statistics-container">
            ...
            <form id="THE-FORM" method="GET" action="{{ config('app.url')}}/budgeting-app/app/statistics/1">
            ...
            @isset($category_selected)
                ...
                @if ($id == 'ALL')
                    ...
                    */
                    ...
                    @endphp
                    <div class="sample-category-container mt-3" id="sample-category-container" style="margin: 0 auto; color: {{$category_selected['color-text']}}; position: relative; background: -moz-linear-gradient(90deg, #FFFFFF, {{$category_selected['color-bg']}});">
                            ...
                            <style type="text/css">
                                ...
                                <table style="width: 100%;" border="2">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$section_key}}</td>
                                            <td>£{{number_format($section_value, 2)}}</td>
                                        </tr>
                                        @endif
                ...
                */
                ...
                <div class="sample-category-container mt-3" id="sample-category-container" style="margin: 0 auto; color: {{$category_selected['color-text']}}; position: relative; background: -moz-linear-gradient(90deg, {{$category_selected['color-bg']}}, {{$category_selected['color-bg']}});">
                    <h3 id="view-category-text">{{$category_selected['name']}}</h3>
                    ...
                    <table class='table view_transaction_table'>
                        ...
                        @foreach($transactions as $transaction)
                            ...
                            @if ($loop->even)
                                ...
                                <tr style="color: {{$category_selected['color-text']}}; background: -moz-linear-gradient(90deg, {{$category_selected['color-bg']}}, {{$category_selected['color-bg']}});">
                                @else

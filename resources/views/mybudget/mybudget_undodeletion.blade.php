...
<body>
    ...
    <div class="container view-transaction-container mt-3">
        <div class="container-headings">
            <h1 style="color: lime; font-weight: 800; transform: skew(-10deg);">UNDO DELETION</h1>
        ...
        <p class="mt-3"> Are you sure you want to undo the deletion of this transaction? </p>

        <form action="/budgeting-app/app/transactions/delete_undo/{{$transaction_id}}" method="POST">
    ...
    <div class="container big-text-container">
        <h1 class="BIG-TEXT" style="font-size: 240px; opacity: 0.4; color: lime;"> UNDO</h1>
    </div>

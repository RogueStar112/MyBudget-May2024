    ...
    <div id="app">
        ...
        <div class="container">
            ...
            <div class="col-md-8 col-xs-12 d" id="MYJOURNAL-CONTAINER">
                <h1 class="col-md-12 col-xs-12" style="font-family: Montserrat;">Write a journal entry<i class="ml-3 fas fa-pen-fancy" style="scale: 1;"></i>
                    <p class="mt-3" style="font-size: 16px; font-family: Luna; ">What's on your mind?</p>
                </h1>
                ...
                <form method="POST" action="{{ config('app.url')}}/journalling-app/entries/">
                    ...
                    <div class="mb-3 row" style="align-items: center;">
                        ...
                        <div class="col-md-10">
                        <input maxlength="50" id="title-form" class="form-control" name="title-form" aria-describedby="titleHelp" style="background-color: lightyellow;" placeholder="Getting things off my chest" required/>
                    ...
                    <div class="mb-3 row" style="align-items: center;">
                      ...
                      <div class="col-md-10">
                      <textarea maxlength="10000" id="content-form" class="form-control" name="content-form" aria-describedby="contentHelp" style="height: 25vh; background-color: lightyellow;" placeholder="I have to admit, I'm feeling..." required></textarea>
